...
description: |
  [TOPIC] Env Vars
  [DETAILS] Environment variables read by scitex-repro at import / runtime. Follow SCITEX_<MODULE>_* convention — see general/10_arch-environment-variables.md.
tags: [scitex-repro-env-vars]
---
