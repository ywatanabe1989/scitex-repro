...
# (project=scitex-repro, owner=ywatanabe1989, repo=scitex-repro,
...
TMPDIR="/tmp/publish-scitex_repro-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-repro dist/* uploaded to PyPI via manual OIDC trusted publishing"
